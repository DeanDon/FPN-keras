...
class Dataset(object):
    ...
    def load_gt(self,image_id):
        """
        Load ground truth with ndarray
        :param image_id: image ID
        :return: groud truth bounding box array [number [x0,y0,x1,y1]]
        """
        pass
...
def resize_gt(gt,scale,padding):
    dtype=gt.dtype
    gt=(gt*scale).astype(dtype)
    top_pad=padding[0][0]
